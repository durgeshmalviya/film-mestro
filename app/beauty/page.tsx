...
const images = [
  {
    ...
    alt: "Beauty fashion photography – Soft Light",
  },
  {
        ...
        <section className="pt-28 md:pt-32 pb-12 md:pb-16 px-5 md:px-10">
          <div className="max-w-[1400px] mx-auto">
            ...
            <p className="text-[#5a5a5a] text-base md:text-lg font-light max-w-2xl leading-relaxed">
              Soft light, skin, and beauty-led fashion imagery — refined for
              campaigns, portfolios, and elevated product storytelling.
            </p>
          </div>
        </section>
