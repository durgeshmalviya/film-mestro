...
const images = [
  {
    ...
    alt: "Fashion lookbook – Golden Hour",
  },
  {
        ...
        <section className="pt-28 md:pt-32 pb-12 md:pb-16 px-5 md:px-10">
          <div className="max-w-[1400px] mx-auto">
            ...
            <p className="text-[#5a5a5a] text-base md:text-lg font-light max-w-2xl leading-relaxed">
              Seasonal and collection lookbooks — clean sequences, strong
              silhouettes, and brand-ready imagery for digital and print.
            </p>
          </div>
        </section>
