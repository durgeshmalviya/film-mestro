...
export default function CatalogPage() {
  ...
  images.forEach((img) => {
    ...
    if (tags.includes("catalouge-1")) {
      key = "Catalogue 1";
    } else if (tags.includes("catalouge-2")) {
      key = "Catalogue 2";
    } else if (tags.includes("catalouge-3")) {
      key = "Catalogue 3";
    } else if (tags.includes("catalouge-4")) {
      key = "Catalogue 4";
    } else if (tags.includes("catalouge-5")) {
      key = "Catalogue 5";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-end">
              <div className="lg:col-span-7">
                ...
                <motion.p
                  ...
                  style={{ color: colors.muted }}
                >
                  Elegant seasonal collections and brand catalogues.
                  Clean direction, refined lighting, and timeless imagery
                  for fashion labels across India.
                </motion.p>
              </div>
                        ...
                        {centerImage && (
                          ...
                          >
                            <SecureImage
                              ...
                              alt={centerImage.alt || `Catalog – ${lookId}`}
        ...
        <section className="px-6 md:px-10 pb-28 md:pb-36">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-light mb-8 tracking-tight">
              Ready for your next catalog shoot?
            </h2>
            <Link
              href="/contact"
