...
const images = [
  {
    ...
    alt: "Editorial fashion photography – Shadow Play",
  },
  {
  ...
  },
  {
    ...
    alt: "Editorial soft light portrait",
  },
  {
        ...
        <section className="pt-28 md:pt-32 pb-12 md:pb-16 px-5 md:px-10">
          <div className="max-w-[1400px] mx-auto">
            ...
            <p className="text-[#5a5a5a] text-base md:text-lg font-light max-w-2xl leading-relaxed">
              High-fashion editorial imagery — precise lighting, intentional
              framing, and storytelling built for magazines, portfolios, and
              brand narratives.
            </p>
          </div>
        </section>
