...
/* -------------------------------------------------------------------------- */
/*  Main Page – Editorial Photography                                         */
/* -------------------------------------------------------------------------- */
export default function EditorialPage() {
  ...
  images.forEach((img) => {
    ...
    // Priority matching for Editorial tags
    if (tags.includes("editorial")) {
      key = "Editorial";
    } else if (tags.includes("campaign-1")) {
      key = "Campaign 1";
    } else if (tags.includes("Editorial")) {
      key = "Editorial";
    } else if (tags.includes("campaign")) {
      key = "Campaign";
  ...
  const preferredOrder = ["Editorial"];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-end">
              <div className="lg:col-span-7">
                ...
                <motion.p
                  ...
                  style={{ color: colors.muted }}
                >
                  Cinematic storytelling and magazine-style fashion editorials.
                  Concept-driven imagery with strong narrative, mood and emotion
                  for designers, publications and luxury brands across India.
                </motion.p>
              </div>
                        ...
                        {centerImage && (
                          ...
                          >
                            <SecureImage
                              ...
                              alt={centerImage.alt || `Editorial – ${lookId}`}
        ...
        <section className="px-6 md:px-10 pb-28 md:pb-36">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-light mb-8 tracking-tight">
              Ready to create your next editorial?
            </h2>
            <Link
              href="/contact"
