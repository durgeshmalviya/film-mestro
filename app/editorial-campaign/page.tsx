...
export default function EditorialPage() {
  ...
  // Change this to your actual Cloudinary folder name for editorial
                    ...
                    return (
                      ...
                      >
                        <SecureImage
                          ...
                          alt={randomImage.alt || "Editorial Photography – Maestro Films"}
              ...
              {images.map((img, i) => (
                ...
                >
                  <div className="relative overflow-hidden h-95">
                    <SecureImage
                      path={img.path}
                      alt={img.alt || `Editorial Photography ${i + 1} – Maestro Films`}
                      width={img.width}
                      height={img.height}
                      priority={i < 4}
