...
export default function BookStudioCTA() {
  ...
  return (
    <section className="relative py-28 sm:py-28 md:py-30 px-5 sm:px-6 md:px-10 overflow-hidden group">
      ...
      <div className="relative -mt-18 z-10 max-w-[1400px] mx-auto text-center -mb-15">
        {/* Eyebrow */}
        <p className="text-[11px] sm:text-xs tracking-[0.35em] uppercase text-[#c9a86c]/80  font-light">
          Studio Booking
        </p>

        {/* Main heading */}
        <h2 className="font-serif text-[2.4rem] sm:text-5xl md:text-6xl lg:text-[4rem] font-normal text-[#f5f1ed]   drop-shadow-[0_4px_30px_rgba(0,0,0,0.6)] leading-[1.1] tracking-tight">
          Ready to book
        ...
        {/* Subtext */}
        <p className="text-[#c9a86c] mb-5 sm:mb-8 max-w-xl mx-auto text-[0.95rem] sm:text-base md:text-lg leading-relaxed font-light px-2">
